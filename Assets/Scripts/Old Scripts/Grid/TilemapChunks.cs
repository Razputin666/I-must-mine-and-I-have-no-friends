...
public class TilemapChunks
{
    ...
    public TilemapChunks(int width, int height, int chunkWidth, int chunkHeight, float cellSize, Vector3 originPosition, TilemapOLD.TilemapObject.TilemapSprite[,] tilemapSpritearray, TilemapVisual tilemapVisual)
    {
        //Total width and height of the terrain.
        this._width = width;
        this._height = height;
        ...
        for (int x = 0; x < _numberOfchunksWidth; x++)
        {
            for (int y = 0; y < _numberOfchunksHeight; y++)
            {
                ...
                TilemapOLD.TilemapObject.TilemapSprite[,] tilemapSpriteArrayCopy = GenerateSpriteCopy(x, y, tilemapSpritearray);
                //Create a new tilemap chunk
                TilemapOLD tilemap = new TilemapOLD(_chunkWidth, _chunkHeight, cellSize, chunkStartPosition, tilemapSpriteArrayCopy);
    ...
    private TilemapOLD.TilemapObject.TilemapSprite[,] GenerateSpriteCopy(int x, int y, TilemapOLD.TilemapObject.TilemapSprite[,] tilemapSpriteArray)
    {
        TilemapOLD.TilemapObject.TilemapSprite[,] tilemapSpriteArrayCopy = new TilemapOLD.TilemapObject.TilemapSprite[_chunkWidth, _chunkHeight];
